...
namespace MyEfOrder
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(Service.deleteOrder(1));
            //Console.WriteLine(Service.searchOrder(2));
            //Console.WriteLine(Service.addOrder("XLX", 3, 334));
            Console.WriteLine(Service.updateOrder(3, "XLXNB", 5, 555));
        }
    }
}
